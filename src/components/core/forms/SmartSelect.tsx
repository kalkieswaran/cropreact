...
const SmartSelect: React.FC<SmartSelectProps> = (props) => {
    ...
    const leftIconDisplay = () => {
        if (leftIcon) {
            return <div className="icon is-small is-left"> <i className={"fa " + leftIcon} /> </div>
    ...
    const rightIconDisplay = () => {
        if (rightIcon) {
            return <div className="icon is-small is-left"> <i className={"fa " + rightIcon} /> </div>
    ...
    const loadOptions = async (inputValue:any, callback:any) => {
       loadOptionsFunction(inputValue,callback);    

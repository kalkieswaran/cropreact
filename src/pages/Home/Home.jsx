    ...
    return (
      <div className="columns is-multiline">
        ...
        <SmartInput key="text-3" label="test"
          ...
          pattern={ALLOW_FLOAT_DYNAMIC(3)}

          inputProps={{ isFocussed: true }}
        />

        <SmartInput key={"text-2"} label="test disabled"
          valueFunction={calculate_sum}
          onChange={(value) => handleInputChange("input_two", value)}
          type="text" min={1} max={5}
          pattern={ALLOW_FLOAT_DYNAMIC(3)}
          inputProps={{ isFocussed: true, disabledFunction: disabledFucntion }}
        />
      </div>
    );
  };
